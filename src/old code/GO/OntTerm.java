...
public class OntTerm {
	...
	public String name;
	public String def;
	int namespace = AnyCategory;
	int numGenes = 0;
	int color = 0;
	public static int BiologicalProcess = 0;
	public static int CellularComponent = 1;
	public static int MolecularFunction = 2;
	public static int AnyCategory = -1;
	static int White = 0;
	static int Gray = 1;
	static int Black = 2;
	...
	public void associateParents(OntDAG DAG) {
	...
	public void getAllParents(HashSet<OntTerm> list,int minGenes,int maxGenes,int useNamespace) {
		if (numGenes >= minGenes && numGenes <= maxGenes && (namespace == useNamespace || useNamespace == OntTerm.AnyCategory)) {
			list.add(this);
		}
		if (parents == null || numGenes > maxGenes || (namespace != useNamespace && useNamespace != OntTerm.AnyCategory)) {
			return;
		}
